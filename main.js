const CHARS = [
  { name: '角色 A', world: '黑白灰',   bg: '#d8d5cf', url: 'worlds/monochrome/index.html' },
  { name: '角色 B', world: '蓝绿',     bg: '#cfdce0', url: 'worlds/bluegreen/index.html'  },
  { name: '角色 C', world: '天国列车', bg: '#dedad2', url: 'worlds/heaven/index.html'     },
  { name: '角色 D', world: 'BIBI',     bg: '#d5d0e0', url: 'worlds/bibi/index.html'       },
  { name: '角色 E', world: '赤色',     bg: '#e0d4d2', url: 'worlds/scarlet/index.html'    },
  { name: '角色 F', world: '黑白灰',   bg: '#d8d5cf', url: 'worlds/monochrome/index.html' },
  { name: '角色 G', world: '蓝绿',     bg: '#cfdce0', url: 'worlds/bluegreen/index.html'  },
  { name: '角色 H', world: '天国列车', bg: '#dedad2', url: 'worlds/heaven/index.html'     },
  { name: '角色 I', world: 'BIBI',     bg: '#d5d0e0', url: 'worlds/bibi/index.html'       },
  { name: '角色 J', world: '赤色',     bg: '#e0d4d2', url: 'worlds/scarlet/index.html'    },
];

// col, row positions (0-indexed) in the 7×4 grid
const FILLED = [
  ...
  for (let r = 0; r < ROWS; r++) {
    for (let c = 0; c < COLS; c++) {
      ...
      if (char) {
        ...
        card.addEventListener('click', () => { if (!wasDragging) window.location.href = char.url; });
...
function startDrag(e, card, char, fromKey) {
  ...
  function move(ev) {
    if (!moved && (Math.abs(ev.clientX - e.clientX) > 4 || Math.abs(ev.clientY - e.clientY) > 4)) {
      moved = true;
      wasDragging = true;
    }
